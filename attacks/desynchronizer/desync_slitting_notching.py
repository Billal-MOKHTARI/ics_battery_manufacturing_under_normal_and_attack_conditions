...
parser = argparse.ArgumentParser(description="Desynchronizer Slitting/Notching Attack", 
                                usage="python3 desync_slitting_notching.py --duration <DURATION>")
parser.add_argument("--duration", help="Duration of the attack in seconds (0 = infinite)", type=int, required=False, default=0)

args = parser.parse_args()

# --- LOGGING SETUP ---
LOG_FILE = "log_desync_slitting_notching.csv"
