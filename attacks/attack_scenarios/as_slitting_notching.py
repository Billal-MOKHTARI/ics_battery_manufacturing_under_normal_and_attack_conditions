...
def bias_injector():
    ...
    subprocess.run([
        "python3",
        "-m",
        "bias_injector.bi_slitting_notching",
...
def coil_manipulation():
    ...
    subprocess.run([
        "python3",
        "-m",
        "coil_manipulation.cm_slitting_notching",
        "--duration", str(random_time)
    ])
...
def holding_register_manipulation():
    ...
    subprocess.run([
        "python3",
        "-m",
        "holding_register_manipulation.hrm_slitting_notching",
        "--duration", str(random_time)
    ])
...
def desynchronizer():
    ...
    subprocess.run([
        "python3",
        "-m",
        "desynchronizer.desync_slitting_notching",
        "--duration", str(random_time)
    ])
...
def plc_reset():
    ...
    subprocess.run([
        "python3",
        "-m",
        "plc_reset.reset_plc_slitting_notching",
        "--duration", str(random_time)
    ])
...
def fuzzing():
    ...
    subprocess.run([
        ...
        "MF/fuzzing_sessions",
        "--log_file",
        "log_fuzzing_slitting_notching.csv"
    ])
